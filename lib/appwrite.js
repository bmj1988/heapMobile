...
export const createNewCard = async (newCardData) => {
    ...
    try {
        const card = await databases.createDocument(config.databaseId, config.cardsCollectionId, ID.uniqute(), {
            ...newCardData
        })
...
export const deleteCard = async (cardId) => {
    try {
        const doom = await databases.deleteDocument(config.databaseId, config.cardsCollectionId, [

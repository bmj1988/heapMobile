...
export const searchListings = async (query) => {
    try {
        const listings = await databases.listDocuments(config.databaseId, config.listingsCollectionId, [Query.or(Query.search('tags', query), Query.search("user", query), Query.search('askingPrice', query))])
